...
require_literal "$runner_comparison_workflow" 'runs-on: size-chungus-x86' 'requested chungus runner label'
reject_text "$runner_comparison_workflow" 'self-hosted-ghr' 'additional EF runner-pool label'
reject_text "$runner_comparison_workflow" 'size-chungus-x68' 'incorrect x68 runner label'
